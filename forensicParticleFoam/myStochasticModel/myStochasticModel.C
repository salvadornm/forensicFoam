...
Foam::myStochasticModel<CloudType>::kModel() const
{
...
template<class CloudType>
Foam::tmp<Foam::volScalarField>
Foam::myStochasticModel<CloudType>::epsilonModel() const
{
    const objectRegistry& obr = this->owner().mesh();
    const word turbName =
        IOobject::groupName
...
template<class CloudType>
Foam::myStochasticModel<CloudType>::myStochasticModel
(
    const dictionary&,
    CloudType& owner
)
...
Foam::myStochasticModel<CloudType>::myStochasticModel
(
    const myStochasticModel<CloudType>& dm
)
:
...
template<class CloudType>
void Foam::myStochasticModel<CloudType>::cacheFields(const bool store)
{
    if (store)
    {
...
template<class CloudType>
void Foam::myStochasticModel<CloudType>::write(Ostream& os) const
{
    myStochasticModel<CloudType>::write(os);
